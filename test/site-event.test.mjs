...
test('published site-event contract is the v2 envelope produced by sites and accepted by cloud',async()=>{
  ...
  assert.deepEqual(schema.required.sort(),['category','entityId','entityType','id','occurredAt','payload','schemaVersion','site','type'].sort());
  assert.deepEqual(schema.properties.category.enum,['Authentication','Inventory','Production','Packaging','Shipping','Labeling','Exceptions','Configuration','Administration','Security']);
